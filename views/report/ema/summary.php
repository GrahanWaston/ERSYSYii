...
<div class="container-fluid p-0">
    ...
    <div class="row justify-content-between align-items-center border">
        ...
        <div class="mt-3">
            <div class="col-auto">
                <?= $this->render('summary_header', get_defined_vars()); ?>
            </div>
        </div>
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'template' => '{view}{report}{validate}{invalidate}',
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<span class="text-primary"><i class="fa-solid fa-eye"></i></span>', ["report/show_ema/", "user_id" => $model->user_id, "month" => $model->month], $options = [
                                        'data-pjax' => "0",
                                    ]);
                                },
                                ...
                                'validate' => function ($url, $model) {
                                    return Html::a('<span class="text-success"><i class="fa-solid fa-circle-check"></i></span>', ["report/show_sda/", "user_id" => $model->user_id], $options = [
                                        'onclick' => "modalFormAjax(this, event)",
                                        'data-pjax' => "0",
                                    ]);
                                },
                                'invalidate' => function ($url, $model) {
                                    return Html::a('<span class="text-warning"><i class="fa-solid fa-circle-xmark"></i></span>', ["report/show_pa/", "id" => $model->id], $options = [
                                        'onclick' => "modalFormAjax(this, event)",
                                        'data-pjax' => "0",
                                    ]);
                                },
